...
#                                                     function(x) replace(x, is.na(x),0)))}
    #the commented out line of code above created those cryptic warnings from before:
#     Warning messages:
#       1: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     2: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     3: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     4: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     5: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     6: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     7: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     8: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     9: In `[<-.factor`(`*tmp*`, list, value = 0) : invalid factor level, NA generated
#     10: In `[<-.factor`(`*tmp*`, list, value = 0) :
#       invalid factor level, NA generated
#     11: In `[<-.factor`(`*tmp*`, list, value = 0) :
#       invalid factor level, NA generated
